...
(function ($) {
  ...
  $.fn.idleTimeout = function (userRuntimeConfig) {
    ...
    openWarningDialog = function () {
      ...
      var dialogContent = "<div id='idletimer_warning_dialog' style='z-index:99999'><p>" + currentConfig.dialogText + "</p><p style='display:inline'>" + currentConfig.dialogTimeRemaining + ": <div style='display:inline' id='countdownDisplay'></div></p></div>";
